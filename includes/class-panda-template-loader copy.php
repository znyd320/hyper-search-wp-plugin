 ...
 * 
 * Handles the loading and rendering of templates for headers, footers, and custom content.
 */
class Template_Loader {
    ...
    /**
     * Handle content filtering for single pages
     *
    ...
    /**
     * Check if before footer is active
     *
     * @return bool
     */
    ...
    /**
     * Get matching templates based on type and conditions
     *
     * @param string $type Template type
    ...
    /**
     * Check if template is specific type
     *
     * @param string $conditions Display conditions
     * @return bool
     */
    ...
    /**
     * Check if template is general type
     *
     * @param string $conditions Display conditions
     * @return bool
     */
    ...
    /**
     * Check display conditions for template
     *
     * @param int $template_id Template ID
     * @return bool
     */
     ...
     *
     * @param string $conditions Display conditions
     * @param string $allowed_roles Allowed user roles
     * @return bool
     */
     ...
     *
     * @param string $user_roles User roles to check
     * @return bool
     */
